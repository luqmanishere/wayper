...
use wayper_windows::config::FitModeConfig;

use crate::renderer::{FitMode, RenderScene, Renderer, TextureHandle};
...
impl Player {
    pub fn image(image_path: PathBuf, fit: FitMode) -> Self {
        Self::Image(ImagePlayer::new(image_path, fit))
    }
...
impl ImagePlayer {
    pub fn new(image_path: PathBuf, fit: FitMode) -> Self {
        Self {
            image_path,
            fit,
            texture: None,
